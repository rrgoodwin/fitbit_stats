...
# curl -X POST -i -H 'Authorization: Basic MjJDUDVOOjI4MzkwMDIxMTkzYWQzMDhkY2I1M2ZkYjU4OTFlMzZi' -H 'Content-Type: application/x-www-form-urlencoded' -d "clientId=22CP5N" -d "grant_type=authorization_code" -d "redirect_uri=https%3A%2F%2Fhr-data.herokuapp.com" -d "code=54682a26f3fd034c2c5c444576659cb8f5bb0aff" https://api.fitbit.com/oauth2/token
